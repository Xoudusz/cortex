#!/usr/bin/env python3
"""Code graph extraction — import/call/inheritance edges, centrality, Louvain communities."""
...
def persist_code_graph(G, metadata: dict, repo_name: str, data_dir: Path) -> None:
